...
def load_data():
    ...
    investors    = pd.read_csv(os.path.join(base, "datasets", "investors.csv"))
    portfolios   = pd.read_csv(os.path.join(base, "datasets", "portfolios.csv"))
    stocks       = pd.read_csv(os.path.join(base, "datasets", "stocks.csv"))
    trades       = pd.read_csv(os.path.join(base, "datasets", "trades.csv"))
    daily_prices = pd.read_csv(os.path.join(base, "datasets", "daily_prices.csv"), parse_dates=["price_date"])
    dividends    = pd.read_csv(os.path.join(base, "datasets", "dividends.csv"), parse_dates=["ex_date", "pay_date"])
